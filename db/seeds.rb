...
d1 = Donation.create(amount: 20, user_id: 17, supply_id: 17)
d2 = Donation.create(amount: 50, user_id: 18, supply_id: 18)
d3 = Donation.create(amount: 15, user_id: 19, supply_id: 19)
d4 = Donation.create(amount: 30, user_id: 20, supply_id: 20)
d5 = Donation.create(amount: 25, user_id: 21, supply_id: 21)
d6 = Donation.create(amount: 13, user_id: 22, supply_id: 22)
d7 = Donation.create(amount: 10, user_id: 23, supply_id: 23)
d8 = Donation.create(amount: 20, user_id: 24, supply_id: 24)

d1 = Donation.create(amount: 8, user_id: 25, supply_id: 25)
d2 = Donation.create(amount: 90, user_id: 26, supply_id: 26)
d3 = Donation.create(amount: 12, user_id: 27, supply_id: 27)
d4 = Donation.create(amount: 14, user_id: 28, supply_id: 28)
d5 = Donation.create(amount: 28, user_id: 29, supply_id: 29)
d6 = Donation.create(amount: 13, user_id: 30, supply_id: 30)
d7 = Donation.create(amount: 9, user_id: 31, supply_id: 31)
d8 = Donation.create(amount: 11, user_id: 32, supply_id: 32)

d1 = Donation.create(amount: 15, user_id: 33, supply_id: 33)
d2 = Donation.create(amount: 5, user_id: 34, supply_id: 34)
d3 = Donation.create(amount: 16, user_id: 1, supply_id: 35)
d4 = Donation.create(amount: 23, user_id: 2, supply_id: 36)
d5 = Donation.create(amount: 27, user_id: 3, supply_id: 37)
d6 = Donation.create(amount: 98, user_id: 4, supply_id: 38)
d7 = Donation.create(amount: 54, user_id: 5, supply_id: 39)
d8 = Donation.create(amount: 3, user_id: 6, supply_id: 40)

d1 = Donation.create(amount: 30, user_id: 7, supply_id: 41)
d2 = Donation.create(amount: 51, user_id: 8, supply_id: 42)
d3 = Donation.create(amount: 16, user_id: 9, supply_id: 43)
d4 = Donation.create(amount: 2, user_id: 10, supply_id: 44)
d5 = Donation.create(amount: 7, user_id: 11, supply_id: 45)
d6 = Donation.create(amount: 19, user_id: 12, supply_id: 46)
d7 = Donation.create(amount: 45, user_id: 13, supply_id: 47)
d8 = Donation.create(amount: 31, user_id: 14, supply_id: 48)

d1 = Donation.create(amount: 20, user_id: 15, supply_id: 49)
d2 = Donation.create(amount: 30, user_id: 16, supply_id: 50)
d3 = Donation.create(amount: 15, user_id: 17, supply_id: 1)
d4 = Donation.create(amount: 90, user_id: 18, supply_id: 5)
d5 = Donation.create(amount: 12, user_id: 19, supply_id: 48)
d6 = Donation.create(amount: 8, user_id: 20, supply_id: 25)
d7 = Donation.create(amount: 10, user_id: 21, supply_id: 13)
d8 = Donation.create(amount: 5, user_id: 22, supply_id: 37)